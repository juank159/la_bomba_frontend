// lib/app/core/services/thermal_printer_sender_io.dart
//
// Real implementation: only compiles outside the web (dart:ffi + win32
// can't even be compiled for a browser, not just unsupported at runtime).
// See thermal_printer_sender.dart for the conditional export that picks
// this file or thermal_printer_sender_web.dart.
