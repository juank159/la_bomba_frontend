...
Future<void> initServiceLocator() async {
  ...
  getIt.registerLazySingleton<VegetablesRemoteDataSource>(
    () => VegetablesRemoteDataSourceImpl(getIt()),
  );
  ...
  getIt.registerLazySingleton(() => DeleteVegetableItemUseCase(getIt()));
