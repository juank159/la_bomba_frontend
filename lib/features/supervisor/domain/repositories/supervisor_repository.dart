...
abstract class SupervisorRepository {
  Future<Either<Failure, List<ProductUpdateTask>>> getPendingTasks({int page = 1, int limit = 20, AssignedRole? assignedRole});
  Future<Either<Failure, List<ProductUpdateTask>>> getCompletedTasks({int page = 1, int limit = 20, AssignedRole? assignedRole});
